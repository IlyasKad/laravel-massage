...
<div id="container__add-anket">
    ...
    <form enctype="multipart/form-data" action="{{route('updateAnketa',$anketa->id)}}" method="post" class="ui form">
        ...
        <div class="field">
            <label id="add__anket-label" for="type">Тип анкеты</label>
...
<div class="two fields">
    ...
    <div class="field">
        ...
        <input id="pris2" class="ui input" name="price_2h_office" maxlength="50" value="{{$anketa->price_2h_office}}">
    </div>
</div>
...
<div class="two fields">
    <div class="field">
        ...
        <input id="pris3" name="price_1h_challenge" class="ui input" maxlength="50"
            value="{{$anketa->price_1h_challenge}}">
    </div>
    <div class="field">
        <label for="pris4">за дві години</label>
        <input id="pris4" name="price_2h_challenge" class="ui input" value="{{$anketa->price_2h_challenge}}">
    </div>
